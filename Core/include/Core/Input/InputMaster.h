...
namespace Core
{
	...
	{
	private:
		std::vector<IInputEventReceiver*> _eventReceivers;

		// Add key remaps array
	public:
		...
		void RegisterEventReceiver(IInputEventReceiver* inputEventReceiver);
		void UnregisterEventReceiver(IInputEventReceiver* inputEventReceiver);
	};
}